...
import { VIVA_RANDOM_CHECK_REQUIRED, ACTIVE_RANDOM_CHECK_REQUIRED_VIVA } from '../../../libs/constants';
...
export async function main(event, context) {
    ...
    const [applicationStatusError, applicationStatusList] = await to(vivaAdapter.application.status(personalNumber));
