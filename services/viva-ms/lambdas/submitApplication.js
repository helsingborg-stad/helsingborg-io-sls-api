...
export async function main(event, context) {
    ...
    if (vivaPostError) {
        log.error('Failed to submit Viva application', context.awsRequestId, 'service-viva-ms-submitApplication-003', {
            axios: { ...vivaPostError },
        });
        return false;
    }
    ...
    if (notApplicationReceived(vivaApplicationResponse)) {
        log.error('Viva application receive failed', context.awsRequestId, 'service-viva-ms-submitApplication-004', {
