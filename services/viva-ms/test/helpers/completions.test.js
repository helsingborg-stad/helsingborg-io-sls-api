  ...
  test.each([
    {
      ...
      expectedResult: COMPLETIONS_RANDOM_SELECT,
      description: `set state to ${COMPLETIONS_RANDOM_SELECT} the first time`,
    },
    {
      conditionOption: {
        requested: [...requestedAllFalseList],
  ...
  test.each([
    {
      ...
      expectedResult: COMPLETIONS_REQUIRED,
      description: `set state to ${COMPLETIONS_REQUIRED} the first time`,
    },
    {
      conditionOption: {
        requested: [...requestedSomeTrueList],
