...
export async function main(event, context) {
    ...
    if (putUserRequestError) {
        log.error('putUserRequestError', context.awsRequestId, 'service-viva-ms-createUser-001', putUserRequestError);
    ...
    if (putEventError) {
        log.error('putEventError', context.awsRequestId, 'service-viva-ms-createUser-002', putEventError);
