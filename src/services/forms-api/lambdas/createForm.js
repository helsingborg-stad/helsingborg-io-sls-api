...
export async function main(event, context) {
    ...
    if (validationErrors) {
        log.error('Validation error', context.awsRequestId, 'service-forms-api-createForm-001', validationErrors);
    ...
    if (dynamodbError) {
        log.error('DynamoDB error', context.awsRequestId, 'service-cases-api-createForm-002', dynamodbError);
