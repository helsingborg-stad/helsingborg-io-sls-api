...
export async function main(event, context) {
    ...
    const [getStoredUserCaseError, storedUserCase] = await getStoredUserCase(config.cases.tableName, PK, SK);
    ...
    if (updateCaseError) {
        log.error('Update case error.', context.awsRequestId, 'service-viva-ms-syncExpiryTime-002', updateCaseError);
        return false;
    }
