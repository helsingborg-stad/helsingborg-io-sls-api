            ...
            if (question.type === 'editableList' && question.inputs) {
                question.inputs.forEach((input) => {
                    if (input.loadPrevious) {
                        ...
                        const loadPrevious = input.loadPrevious.map((value) => (value === input.key ? inputId : value));
...
export function populateFormWithPreviousCaseAnswers(forms, applicants, formTemplates, previousForms) {
